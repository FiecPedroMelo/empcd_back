...
EmpresaRouter.get("/:Token/vaga/:IdVaga/getStatus", new Vaga_controllers_1.default().statusVaga); //ok - token
...
EmpresaRouter.put('/:Token/vaga/:IdVaga/finalizaVaga', new Vaga_controllers_1.default().mudaStatusVaga); //ok - token
